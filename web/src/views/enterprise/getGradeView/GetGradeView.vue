<template>
    ...
    <el-table :data="data" table-layout="auto" height="400" stripe style="width:1080px; margin: 20px 120px;">
        <el-table-column width="90px" prop="testPaperId" label="场次"></el-table-column>
        <el-table-column width="360px" prop="testPaperTitle" label="标题"></el-table-column>
    ...
    <el-pagination @current-change="changePage" :page-size="10" :total="dataCount" layout="prev, pager, next" background/>
</template>
...
function changePage(page:number)   {
    $.ajax({
        url: 'http://127.0.0.1:3000/enterprise/get/candidate/grade/',
        type: 'post',
        headers: {
